...
Скопирован файл skills/geo-citability/SKILL.md без изменений содержания.
...
| **Codex** | Prefers well-structured, comprehensive passages. Values nuance and accuracy over brevity. |
